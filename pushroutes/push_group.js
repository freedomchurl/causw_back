...
router.post('/',function(req,res){
	...
	decoded = null;
	try{
		decoded = jwt.verity(token,private_key)
	}
	catch(e){
	...
	if(decoded){
		...
		pool.getConnection(function(err,conn){
			...
			var exec = conn.query('select a.token from fcm_tokens a inner join usergroups b on a.userId=b.userId where b.groupId=?',groupId,function(err,result){
