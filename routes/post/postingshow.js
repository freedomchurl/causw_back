...
router.post('/', function (req, res, next) {
	...
	var url;
	if (page_info[0] == 1) {
		url = "http://127.0.0.1:"+port+"/council/post/show";
	} else if (page_info[0] == 2) {
		url = "http://127.0.0.1:"+port+"/group/post/show";
	} else if (page_info[0] == 3) {
		url = "http://127.0.0.1:"+port+"/alumni/post/show";
	} else if (page_info[0] == 4) {
		url = "http://127.0.0.1:"+port+"/alumni/post/show";
	}else if (page_info[0] == 5) {
		url = "http://127.0.0.1:"+port+"/dev/post/show";
	}
